...
#     General tab
    ...
    name_in_passport = fields.Char('Name In Password', translate=True)
...
#     IT
    ...
    compute_id = fields.Many2one('account.asset.asset', string="Computer")
    phone_tag = fields.Char('Phone Tag')
    mobile_id = fields.Many2many('account.asset.asset', string="Mobile")
